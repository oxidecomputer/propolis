...
impl Chipset for I440FxHostBridge {
    ...
    fn pci_detach(&self, bdf: Bdf) {
        self.pci_topology
            .pci_detach(LogicalBusId(bdf.bus.get()), bdf.location)
            .unwrap();
    }
    fn pci_hot_attach(
        &self,
        ...
        self.pci_attach(bdf, dev, lintr_cfg);
        self.acpi.plug_device(bdf.location.dev.into());
    }
