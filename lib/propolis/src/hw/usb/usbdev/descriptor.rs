...
pub struct DeviceDescriptor {
    ...
    /// bDeviceClass. If 0, each interface specifies its own class information
    /// and operates independently.
    /// If 1..=254, interfaces may not operate independently, and the value
    /// identifies the class definition used for the aggregate interfaces.
    /// If 255, the device class is vendor-specific.
    ...
    /// Descriptors of the configurations supported by this device.
    /// bNumConfigurations (u8) is the length of this Vec.
...
pub struct ConfigurationDescriptor {
    /// Descriptors of the interfaces within this configuration.
    /// wTotalLength (u16) is calculated based on serialization of,
    /// and bNumInterfaces (u8) is the length of, this Vec.
...
pub struct InterfaceDescriptor {
    ...
    /// Descriptors of the endpoints defined by this interface.
    /// bNumEndpoints is the length of this Vec.
