...
//! This module implements the transitions between [port states] in response
//! to writes to the [PORTSC] register, as depicted in xHCI 1.2 figure 4-25
//! (and discussed in section 4.19).
//!
//! [port states]: bits::PortLinkState
...
use crate::hw::usb::xhci::bits::{
    self, ring_data::TrbCompletionCode, PortStatusControl,
};
use crate::hw::usb::xhci::registers::PortRegisters;
use crate::hw::usb::xhci::rings::producer::event::EventInfo;
use crate::hw::usb::xhci::{RegRWOpValue, MAX_PORTS};
...
/// Valid values are 1 through MAX_PORTS.
/// IDs 1 through NUM_USB2_PORTS correspond to USB 2.0 device ports,
/// and NUM_USB2_PORTS+1 through MAX_PORTS correspond to USB 3.0 ports.
...
pub(super) trait XhciUsbPort: XhciUsbPortPrivate + Send + Sync {
    ...
    /// Enqueues a Port Status Change Event in the Event Ring if the
    /// PSCEG signal changes from 0 to 1.
