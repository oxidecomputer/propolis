...
impl VqUsed {
    ...
    /// Returns true iff notificatoins are surprised on for this queue.
...
impl VirtQueues {
    ...
    pub fn import(
        ...
        self.set_len(state.len as usize);
        Ok(())
    }
}
