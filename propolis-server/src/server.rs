...
mod tests {
    ...
    use crate::test_utils::{setup, TEST_IMAGE, TEST_BOOTROM};

    async fn initialize_server() -> HttpServer<super::Context> {
        setup().await;
        ...
        let context = super::Context::new(config);
        ...
        let log = config_logging
            ...
            .unwrap();
        HttpServerStarter::new(&config_dropshot, super::api(), context, &log)
            .unwrap()
            .start()
    }
