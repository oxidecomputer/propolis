...
use super::components::devices::{UsbDevice, XhciController};
...
#[error("no such v3 component: {0:?}")]
pub struct InvalidV3Component(Component);
...
impl TryFrom<Component> for V3Component {
    ...
    fn try_from(value: Component) -> Result<Self, Self::Error> {
        Ok(match value {
            ...
            Component::NvmeDisk(c) => V3Component::NvmeDisk(c),
            ...
            component @ (Component::UsbDevice(_)
            | Component::XhciController(_)) => {
                return Err(InvalidV3Component(component))
            }
        })
    }
}
...
impl From<V3Component> for Component {
    fn from(old: V3Component) -> Self {
        match old {
            ...
            V3Component::NvmeDisk(c) => Component::NvmeDisk(c),
